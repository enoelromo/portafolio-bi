...
const t = {
  es: {
    ...
    "hero.quick.1": "4+ años en BI: SQL, modelado, ETL.",
    "hero.quick.2": "PostgreSQL + vistas materializadas para baja latencia.",
    "hero.quick.3": "Dashboards claros para decisiones rápidas.",
  ...
  en: {
    ...
    "hero.quick.1": "4+ years in BI: SQL, modeling, ETL.",
    "hero.quick.2": "PostgreSQL + materialized views for low latency.",
    "hero.quick.3": "Clear dashboards for fast decisions.",
  ...
  fr: {
    ...
    "hero.quick.1": "4+ ans en BI : SQL, modélisation, ETL.",
    "hero.quick.2": "PostgreSQL + vues matérialisées pour faible latence.",
    "hero.quick.3": "Dashboards clairs pour décider vite.",
